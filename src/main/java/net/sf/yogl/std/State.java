...
public abstract class State <VK extends Comparable<VK>, EK extends Comparable<EK>, DS extends State<VK, EK, DS, TS, PAR>, TS extends Transition<EK, VK, TS, DS, PAR>, PAR>
	 ...
	 * @throws Exception
	 */
	public abstract boolean checkBeforeEntry(DS comingFrom, TS using, PAR parameter)
	 ...
	 *         previous node.
	 */
	public abstract boolean onEntry(DS comingFrom, TS using, PAR parameter)
		throws StdExecutionException;
	 ...
	 *         'current state'.
	 */
	public abstract boolean reEntryAfterBacktrack(DS from, TS using, PAR parameter, Exception e)
		throws StdExecutionException;
	 ...
	 * @throws Exception
	 */
	public abstract boolean checkBeforeExit(DS navigatingTo, TS using, PAR parameter)
		throws StdExecutionException;
	 ...
	 *         current state.
	 */
	public abstract boolean onExit(DS navigatingTo, TS using, PAR parameter)
		throws StdExecutionException;
	 ...
	 * @throws Exception
	 */
	public abstract boolean exitAfterBacktrack(DS navigatingTo, TS using, PAR parameter)
		throws StdExecutionException;
}
